 ...
 * ------------------------ */
   ...
   */
   ...
   @exception  IllegalArgumentException All rows must have the same norm
   ...
   */
   ...
   @param m    Number of rows.
   @exception  IllegalArgumentException Array norm must be a multiple of m.
   */
      ...
      for (int i = 0; i < m; i++) {
         if (A[i].length != n) {
            throw new IllegalArgumentException
               ("All rows must have the same norm.");
         }
         for (int j = 0; j < n; j++) {
            C[i][j] = A[i][j];
         }
